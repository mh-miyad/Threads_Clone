...
const BackdropFilter = () => {
  return (
    <>
      <div className="fixed top-80 right-0 bg-gradient-to-r from-violet-600 to-indigo-500 w-32 h-32 sm:w-80 sm:h-32 sm:right-20 sm:top-[300px] rounded-l-2xl blur-3xl  -z-30 rounded-t-3xl rotate-45 animate-pulse  delay-300 transition-all ">
        {" "}
      </div>
      <div className="fixed top-[420px] right-0 bg-gradient-to-r from-pink-600 to-orange-600 w-32 h-32 sm:w-80 sm:h-32 sm:right-20 sm:top-[600px] rounded-l-2xl blur-3xl  -z-30 rounded-t-3xl rotate-45 animate-pulse  delay-300 transition-all opacity-80 ">
        {" "}
      </div>
